namespace MFTWebForm.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MFTWebForm.Models.DataContext>
    {
        ...
        protected override void Seed(MFTWebForm.Models.DataContext context)
        {
